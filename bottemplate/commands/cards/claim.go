...
func (h *ClaimHandler) HandleCommand(e *handler.CommandEvent) error {
	...
	for i, cardWithExp := range selectedCardsWithEXP {
		if err := claimCardTx(ctx, tx, h.bot, cardWithExp.card.ID, userID, claimCosts[i], cardWithExp.exp); err != nil {
...
func claimCard(ctx context.Context, b *bottemplate.Bot, cardID int64, userID string, claimCost int64, initialExp int64) error {
	...
	if err := claimCardTx(ctx, tx, b, cardID, userID, claimCost, initialExp); err != nil {
		return err
	}
...
func claimCardTx(ctx context.Context, tx bun.Tx, b *bottemplate.Bot, cardID int64, userID string, claimCost int64, initialExp int64) error {
